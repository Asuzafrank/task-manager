...
const addTask = async() => {
    ...
    try{
        let res = await axios.post('http://localhost:5000/tasks', newTask)
        if(res.status == 201){
        ...
        <div class="bg-white rounded shadow-lg mx-auto max-w-md mt-5 p-6">
            <form @submit.prevent="addTask">
                ...
                <div class="text-center">
                    <button class="bg-sky-700 text-white ring-2 ring-blue-900 hover:bg-purple-600 rounded-lg py-3 px-20">Add Task</button>
                </div>
